...
const KEYMESH_TEAM_ADDRESS = '0xBd04D16F09506e80d1FD1fD8D0C79Afa49bd9976'
const DEPLOYED_NETWORK_ID = 4 // RINKEBY

export default process.env.NODE_ENV === 'production' ? {
  DEPLOYED_NETWORK_ID,
  KEYMESH_TEAM_ADDRESS,
  ...
  AWS_API_PREFIX: BETA_OAUTH_API_PREFIX,
  ...
  AWS_API_PREFIX: DEV_OAUTH_API_PREFIX,
