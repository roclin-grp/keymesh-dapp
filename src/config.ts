...
export default process.env.NODE_ENV === 'production' ? {
  ...
  TWITTER_OAUTH_API: TEST_OAUTH_API_PREFIX + TWITTER_OAUTH_PATH,
  TWITTER_OAUTH_CALLBACK: TEST_OAUTH_API_PREFIX + TWITTER_OAUTH_CALLBACK_PATH,
  TWITTER_OAUTH_VERIFY: TEST_OAUTH_API_PREFIX + TWITTER_OAUTH_VERIFY_PATH,
  PREKEYS_API: TEST_OAUTH_API_PREFIX + PREKEYS_PATH,
